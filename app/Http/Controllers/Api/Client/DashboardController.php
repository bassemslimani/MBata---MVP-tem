...
class DashboardController extends Controller
{
     ...
     *
     * Returns:
     * - Active reservations count (pending, confirmed, or checked in)
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        // Active reservations (pending, confirmed, or checked_in - not cancelled or completed)
        ...
        return response()->json([
            'success' => true,
            'message' => $this->getMessage('dashboard_stats', $request->header('Accept-Language')),
            'data' => [
                'stats' => $stats,
